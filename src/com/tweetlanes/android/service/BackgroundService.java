...
public class BackgroundService extends Service {
    ...
    private BroadcastReceiver mStateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            mContext = context;
            /*
             * if (BROADCAST_REFRESHSTATE_CHANGED.equals(action)) { if
             * (!mAsyncTaskManager.hasActivatedTask() && mShouldShutdown) {
             * stopSelf(); } } else if
             * (BROADCAST_NOTIFICATION_CLEARED.equals(action)) { final Bundle
             * extras = intent.getExtras(); if (extras != null &&
             * extras.containsKey(INTENT_KEY_NOTIFICATION_ID)) {
    ...
    private final Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case ACTION_AUTO_REFRESH: {
                 ...
                 * getActivatedAccountIds(TwidereService.this); if
                 * (mPreferences.
                 * getBoolean(PREFERENCE_KEY_REFRESH_ENABLE_HOME_TIMELINE,
                 * false)) { if (!isHomeTimelineRefreshing()) {
                 * getHomeTimeline(activated_ids, null, true); } } if
                 * (mPreferences
                 * .getBoolean(PREFERENCE_KEY_REFRESH_ENABLE_MENTIONS, false)) {
                 * if (!isMentionsRefreshing()) { getMentions(activated_ids,
                 * null, true); } } if (mPreferences.getBoolean(
                 * PREFERENCE_KEY_REFRESH_ENABLE_DIRECT_MESSAGES, false)) { if
    ...
    public void clearNotification(int id) {
        switch (id) {
        /*
         * case NOTIFICATION_ID_HOME_TIMELINE: { mNewStatusesCount = 0; break; }
         * case NOTIFICATION_ID_MENTIONS: { mNewMentionsCount = 0; break; } case
         * NOTIFICATION_ID_DIRECT_MESSAGES: { mNewMessagesCount = 0; break; }
         */
        }
    ...
    public void onCreate() {
        ...
        // mAsyncTaskManager = ((TwidereApplication)
        // getApplication()).getAsyncTaskManager();
        // mPreferences = getSharedPreferences(SHARED_PREFERENCES_NAME,
        // MODE_PRIVATE);
        // final IntentFilter filter = new
        // IntentFilter(BROADCAST_REFRESHSTATE_CHANGED);
    ...
    private Notification buildNotification(String message, int icon,
            Intent content_intent, Intent delete_intent) {
        ...
        builder.setDeleteIntent(PendingIntent.getBroadcast(this, 0,
                delete_intent, PendingIntent.FLAG_UPDATE_CURRENT));
        builder.setContentIntent(PendingIntent.getActivity(this, 0,
                content_intent, PendingIntent.FLAG_UPDATE_CURRENT));
        int defaults = 0;
    ...
    private void showNotification() {
        ...
        Notification notification = new Notification(R.drawable.ic_launcher,
                "Message preview here", System.currentTimeMillis());
        // The PendingIntent to launch our activity if the user selects this
        // notification
        PendingIntent contentIntent = PendingIntent.getActivity(this, 0,
                new Intent(this, HomeActivity.class), 0);
        // Set the info for the views that show in the notification panel.
        notification.setLatestEventInfo(this, "Count = " + mCount,
                "Full message here", contentIntent);
        // Send the notification.
        // We use a layout id because it is a unique number. We use it later to
        // cancel.
        mNotificationManager2.notify(112344, notification);
    }
