...
public class App extends Application {
    ...
    private static int sAppVersionNumber;
    private static String sAppVersionName;
    private static boolean sActionLauncherInstalled;
    ...
    public static boolean getActionLauncherInstalled() {
        return sActionLauncherInstalled;
    }
    ...
    public void onCreate() {
        ...
        try {
            ...
            PackageInfo packageInfo = packageManager.getPackageInfo(
                    getPackageName(), 0);
            sAppVersionNumber = packageInfo.versionCode;
        ...
        AppSettings.initModule(sContext);
    ...
    public void clearImageCaches() {
        if (sContext != null) {
            UrlImageViewHelper.emptyCache(sContext);
        }
