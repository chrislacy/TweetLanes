...
public abstract class ComposeBaseFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		/*
		int a = getStatusLength("       length");
		int b = getStatusLength("       length       ");
		int c = getStatusLength("Hi there. Hi there. Hi there. Hi there. Hi there. Hi there. Hi there. Hi there. Hi there. Hi there. Hi there. Hi there. Hi there. Hi there. Hi there. Hi there. Hi there.");
		int d = getStatusLength("   http://google.com/docs/maple/apple");
		int e = getStatusLength("http://google.com/docs/maple/apple/longlonglonglonglong");
		int ee = getStatusLength("https://google.com/docs/maple/apple https://www.apple.com/buy_my_new_ipad?you_really_should");
		int f = getStatusLength("https://google.com/docs/maple/apple https://www.apple.com/buy_my_new_ipad?you_really_should yes yes yes     ");
		int g = getStatusLength("https://google.com/docs/maple/apple https://www.apple.com/buy_my_new_ipad?you_really_should yes yes yes     .");
		*/
	...
	void showToast(String message) {
		if (getActivity() != null && getActivity().getApplicationContext() != null) {
			Toast.makeText(getActivity().getApplicationContext(), message, Constant.DEFAULT_TOAST_DISPLAY_TIME).show();
		}
	}
	...
	void hideKeyboard() {
        ...
        //inputMethodManager.hideSoftInputFromWindow(mStatusEditText.getApplicationWindowToken(), 0);
	}
	...
	void clearCompose(boolean saveCurrentTweet) {
		...
		// NOTE: Changing these text values causes a crash during the copy/paste process. 
	 ...
	 * 
	 */
	void showCompose()	{ showCompose(null); }
	...
	protected ComposeTweetDefault getComposeTweetDefault() 	{ return _mComposeDefault; }
