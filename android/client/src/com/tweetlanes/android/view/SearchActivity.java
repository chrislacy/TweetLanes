...
public class SearchActivity extends BaseLaneActivity {
     ...
     * 
     */
	class SearchAdapter extends FragmentStatePagerAdapter implements TitleProvider {
		...
		public Fragment getItem(int position) {
			...
			LaneDescriptor laneDescriptor = getApp().getSearchLaneDescriptor(position);
			switch (laneDescriptor.getLaneType())
			{
				case SEARCH_TERM:
					result = TweetFeedFragment.newInstance(position, laneDescriptor.getContentHandleBase(), mSearchTerm, null);
					break;
					
				case SEARCH_PERSON:
					result = UserFeedFragment.newInstance(position, laneDescriptor.getContentHandleBase(), mSearchTerm, null);
					break;
		...
		public String getTitle(int position) {
			return getApp().getSearchLaneDescriptor(position).getLaneTitle().toUpperCase();
		}
