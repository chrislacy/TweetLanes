...
public class ProfileFragment extends BaseLaneFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		mProfileView = inflater.inflate(Constant.SOCIAL_NET_TYPE == SocialNetConstant.Type.Appdotnet ? R.layout.profile_adn : R.layout.profile, null);
		...
		if (mFollowsLoggedInUser == null && mUser != null && mFriendshipCallback == null) {
			...
			if (currentUserScreenName != null) {
				...
				TwitterManager.get().getFriendshipExists(mUser.getScreenName(), currentUserScreenName, mFriendshipCallback);
			}
		}
	...
	private OnClickListener mFrienshipButtonListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			if (mUser != null && mLoggedInUserFollows != null && mUpdateFriendshipFinishedCallback == null) {
				...
				mUpdateFriendshipFinishedCallback = TwitterManager.get().getFetchUsersInstance().new FinishedCallback() {
				...
				TwitterManager.get().updateFriendship(loggedInUserScreenName, mUser, willCreateFriendship, mUpdateFriendshipFinishedCallback);
			}			
		}
	...
	public void triggerInitialDownload() {
		...
		TwitterFetchUser.FinishedCallback callback = TwitterManager.get().getFetchUserInstance().new FinishedCallback() {
