...
public class LaneDescriptor {
	 ...
	 * 
	 */
	public LaneDescriptor(Constant.LaneType laneType, String laneTitle, TwitterContentHandleBase contentHandleBase) {
	 ...
	 * 
	 */
	public LaneDescriptor(Constant.LaneType laneType, String laneTitle, String identifier, 
	 ...
	 * 
	 */
	public Constant.LaneType 		getLaneType()				{ return mLaneType; }
	public TwitterContentHandleBase	getContentHandleBase()		{ return mContentHandleBase; }
	public String					getLaneTitle()				{ return mLaneTitle; }
	public void						setLaneTitle(String title)	{ mLaneTitle = title; }
	public String					getIdentifier()				{ return mIdentifier; }
	public boolean					getDisplay()				{ return mDisplay; }
	public void						setDisplay(boolean display)	{ mDisplay = display; }
	
	/*
	 * 
	 */
	public String getCacheKey(String accountName) {
		String key = accountName + "_" + mLaneType.toString() + "_" + getLaneTitle();
		if (mIdentifier != null) {
			key += "_" + mIdentifier;
		}
