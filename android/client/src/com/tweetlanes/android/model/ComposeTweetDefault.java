...
public class ComposeTweetDefault {
	 ...
	 * 
	 */
	public ComposeTweetDefault(String userScreenName, String defaultStatus, Long inReplyToStatusId, String mediaFilePath) {
	...
	public ComposeTweetDefault(String userScreenName, TwitterStatuses inReplyToStatusList) {
		...
		this(userScreenName, 
			 ...
			 (inReplyToStatusList != null && inReplyToStatusList.getStatusCount() > 0 ? inReplyToStatusList.getStatus(0).mId : null), 
			 null);
	...
	public String getMediaFilePath()					{ return mMediaFilePath; }
	public void setMediaFilePath(String filePath)		{ mMediaFilePath = filePath; }
	...
	public boolean isPlaceholderStatus() {
		if (mInitialStatus != null && mStatus != null && mInitialStatusIsPlaceholder == true && mInitialStatus.equals(mStatus) == true) {
			return true;
		}
	...
	private static String getReplyToUserNamesAsString(String userScreenName, TwitterStatuses inReplyToStatusList) {
		...
		// Note: There are 2 for loops here so that we cleanly handle the case where a user replies to their own tweet.
