...
/*
 * Original code obtained from http://stackoverflow.com/questions/4599786/android-linkify-both-web-and-mentions-all-in-the-same-textview
 */
    ...
    public static final boolean addLinks(Spannable text, int mask) {
        ...
        if((mask & AT_MENTIONS) != 0){
            gatherLinks(links, text, Pattern.compile("@([A-Za-z0-9_-]+)"),
                    new String[] { "com.tweetlanes.android.profile://" },
                    null, null);
        }

        if((mask & HASH_TAGS) != 0){
            gatherLinks(links, text, Pattern.compile("#([A-Za-z0-9_-]+)"),
                new String[] { "com.tweetlanes.android.search://" },
                null,null);
        }
