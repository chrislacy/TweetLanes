...
public abstract class AsyncTaskEx<Params, Progress, Result> {
    ...
    /*
     * Some basic priorities. You can however use any or as many integers to
     * define your priorities as you like
     */
    ...
    public AsyncTaskEx() {
        mWorker = new WorkerRunnable<Params, Result>() {
            public Result call() throws Exception {
                ...
                // Log.d("AsyncTaskEx", "[Priority " + mPriority + "] " +
                // (mDescription != null ?
                // mDescription : "") );
     ...
     * use this function with {@link #DEFAULT_EXECUTOR}.
     * <p/>
     * <p/>
     * This method must be invoked on the UI thread.
     *
