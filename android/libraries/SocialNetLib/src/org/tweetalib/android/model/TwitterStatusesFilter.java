...
public final class TwitterStatusesFilter {
	...
	enum FilterType {
		...
		HIDE_RETWEETS,
		HIDE_REPLIES,
		HIDE_RETWEETS_REPLIES,
		FILTER_MAX,
	};
	
	public void setShowRetweets(boolean show) 	{ mShowRetweets = show; }
	public boolean	getShowRetweets()			{ return mShowRetweets; }
	
	public void setShowReplies(boolean show) 	{ mShowReplies = show; }
	public boolean	getShowReplies()			{ return mShowReplies; }
