...
public class TwitterDirectMessage implements Comparable<TwitterDirectMessage> {
	...
	public TwitterDirectMessage(DirectMessage message, User otherUser) {
		mId = message.getId();
		mMessageType = message.getRecipientId() == otherUser.getId() ? MessageType.SENT : MessageType.RECEIVED; 
	...
	public long getOtherUserId()			{ return mOtherUserId; }
	public String getOtherUserName()		{ return mOtherUserName; }
	public String getOtherUserScreenName()	{ return mOtherUserScreenName; }
