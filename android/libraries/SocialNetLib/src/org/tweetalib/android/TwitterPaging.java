...
public class TwitterPaging {
	...
	public TwitterPaging(Integer page, Integer count, Long sinceId, Long maxId) {
		...
		if (maxId != null && maxId > 0) {
			mMaxId = maxId - 1;			// Decrement by 1 so we don't fetch the current tweet again. Bit of a hack...
			// TODO: Fix me
			if (mMaxId < 0) {
	...
	public AdnPaging getAdnPaging() {
		/*
		AdnPaging result = new AdnPaging();
		if (mMaxId == null && mSinceId == null) {
	...
	public Long getMaxId()			{ return mMaxId; }
	public Long getSinceId()		{ return mSinceId; }
