...
public class TwitterContentHandleBase implements Serializable {
	...
	public TwitterContentHandleBase(ContentType contentType, DirectMessagesType directMessagesType) {
	...
	public TwitterContentHandleBase(ContentType contentType, StatusType statusType) {
		this(contentType, null, statusType, null, null);
	}
	
	public TwitterContentHandleBase(ContentType contentType, StatusesType statusesType) {
	...
	public TwitterContentHandleBase(ContentType contentType, DirectMessagesType directMessagesType, 
			StatusType statusType, StatusesType statusesType, UsersType usersType) {
	...
	public DirectMessagesType getDirectMessagesType() { return mDirectMessagesType; }
	public StatusType getStatusType()		{ return mStatusType; }
	public StatusesType getStatusesType()	{ return mStatusesType; }
	public UsersType getUsersType()			{ return mUsersType; }
