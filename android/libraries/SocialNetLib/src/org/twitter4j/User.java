...
public interface User extends Comparable<User>, TwitterResponse, java.io.Serializable {
    ...
    /**
     * Returns true if the authenticating user is being followed by this user, otherwise false
     *
     * @return true if the authenticating user is being followed by this user
     * 
     */
    boolean isFollowing();
}
