...
public interface ListMethods {
     ...
     * @throws org.twitter4j.TwitterException when Twitter service or network is unavailable, or the authenticated user already has 20 lists(TwitterException.getStatusCode() == 403).
     ...
     * @since org.twitter4j 2.1.0
     * @deprecated use {@link #getUserListStatuses(int, org.twitter4j.Paging)} instead
     */
     ...
     * <br>http://api.twitter.com/1/user/lists/list_id/statuses.json
     *
     * @param ownerScreenName the screen name of the user
     ...
     * @since org.twitter4j 2.2.3
     */
    ResponseList<Status> getUserListStatuses(String ownerScreenName, String listSlug, Paging paging)
            throws TwitterException;
