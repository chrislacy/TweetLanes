...
import org.twitter4j.AccountSettings;
import org.twitter4j.AccountTotals;
import org.twitter4j.RateLimitStatus;
...
public interface AccountMethods {
     ...
     *
     * @return user
     * @throws org.twitter4j.TwitterException when Twitter service or network is unavailable, or if supplied credential is wrong (TwitterException.getStatusCode() == 401)
