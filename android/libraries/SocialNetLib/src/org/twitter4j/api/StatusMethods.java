...
public interface StatusMethods {
     ...
     * @throws org.twitter4j.TwitterException when Twitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1/get/statuses/show/:id">GET statuses/show/:id | Twitter Developers</a>
     * @since org.twitter4j 2.0.1
     */
     ...
     * @deprecated use {@link #getRetweetedBy(long, org.twitter4j.Paging)} instead
     */
     ...
     * @since org.twitter4j 2.1.3
     * @deprecated use {@link #getRetweetedByIDs(long, org.twitter4j.Paging)} instead
     */
