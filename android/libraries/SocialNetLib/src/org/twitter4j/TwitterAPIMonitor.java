...
//import org.twitter4j.management.APIStatisticsOpenMBean;
...
public class TwitterAPIMonitor {
    ...
    static {
        ...
        try {
            ...
            if (isJDK14orEarlier) {
                ObjectName oName = new ObjectName("org.twitter4j.mbean:type=APIStatistics");
                mbs.registerMBean(statsMBean, oName);
            } else {
                ObjectName oName = new ObjectName("org.twitter4j.mbean:type=APIStatisticsOpenMBean");
