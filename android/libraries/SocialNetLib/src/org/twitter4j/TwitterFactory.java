...
public final class TwitterFactory implements java.io.Serializable {
    ...
    static {
        ...
        if (ConfigurationContext.getInstance().isGAE()) {
            final String APP_ENGINE_TWITTER_IMPL = "org.twitter4j.AppEngineTwitterImpl";
            try {
        ...
        if (className == null) {
            className = "org.twitter4j.TwitterImpl";
        }
     ...
     * consumer key and consumer Secret must be provided by org.twitter4j.properties, or system properties.<br>
     * Unlike {@link Twitter#setOAuthAccessToken(org.twitter4j.auth.AccessToken)}, this factory method potentially returns a cached instance.
     *
