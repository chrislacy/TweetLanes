...
import org.twitter4j.Annotations;
import org.twitter4j.GeoLocation;
import org.twitter4j.HashtagEntity;
...
import static org.twitter4j.internal.util.z_T4JInternalParseUtil.getDate;
import static org.twitter4j.internal.util.z_T4JInternalParseUtil.getLong;
import static org.twitter4j.internal.util.z_T4JInternalParseUtil.getRawString;
import static org.twitter4j.internal.util.z_T4JInternalParseUtil.getUnescapedString;
...
/*package*/ final class TweetJSONImpl implements Tweet, java.io.Serializable {
    ...
    /*package*/ TweetJSONImpl(JSONObject tweet) throws TwitterException {
        ...
        inReplyToUserId = getLong("in_reply_to_user_id", tweet);
    ...
    public int hashCode() {
        ...
        result = 31 * result + (inReplyToStatusId != -1 ? (int) (inReplyToStatusId ^ (inReplyToStatusId >>> 32)) : 0);
        result = 31 * result + (inReplyToUserId != -1 ? (int) (inReplyToUserId ^ (inReplyToUserId >>> 32)) : 0);
        return result;
    }
