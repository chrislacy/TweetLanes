...
import org.twitter4j.PagableResponseList;
...
import static org.twitter4j.internal.util.z_T4JInternalParseUtil.getBoolean;
...
/*package*/ final class UserJSONImpl extends TwitterResponseImpl implements User, java.io.Serializable {
    ...
    private void init(JSONObject json) throws TwitterException {
        try {
            ...
            isFollowing = false;//getBoolean("following", json);
