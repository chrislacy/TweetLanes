...
package org.twitter4j.internal.util;
...
import org.twitter4j.internal.http.HTMLEntity;
    ...
    public static int getInt(String str) {
        if (null == str || "".equals(str) || "null".equals(str)) {
            ...
            try {
                ...
                // workaround for the API side issue http://org.twitter4j.org/jira/browse/TFJ-484
                return -1;
            }
        }
    }
