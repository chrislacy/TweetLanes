...
/**
 * A builder that can be used to construct a org.twitter4j configuration with desired settings.  This
 ...
 * org.twitter4j in unit tests or from command line flags for example.
 *
