...
public class NotificationCompat {
    /**
     * Bit to be bitwise-ored into the {@link Notification#flags} field that
     * should be set if this notification represents a high-priority event that
     * may be shown to the user even if notifications are otherwise unavailable
     * (that is, when the status bar is hidden). This flag is ideally used in
     * conjunction with fullScreenIntent.
     * 
     * <p>
    ...
    public static class Builder {
         ...
         */
        /*
         * TODO public Builder setProgress(int max, int progress, boolean
         * indeterminate) { mProgressMax = max; mProgress = progress;
         * mProgressIndeterminate = indeterminate; return this; }
         */
