...
public class NavUtils {
     ...
     * should synthesize a new task stack by using {@link TaskStackBuilder} or
     * another similar mechanism to perform up navigation.
     * </p>
     * 
    ...
    /**
     * Obtain an {@link Intent} that will launch {@link Intent#ACTION_MAIN} with
     * an explicit target activity specified by sourceActivity's
     * {@link #PARENT_ACTIVITY} &lt;meta-data&gt; element in the application's
     * manifest.
     * 
     * @param sourceActivity
    ...
    public static Intent getParentActivityIntent(Activity sourceActivity) {
        ...
        return new Intent(Intent.ACTION_MAIN).setClassName(sourceActivity,
                parentActivity);
    }

    /**
     * Obtain an {@link Intent} that will launch {@link Intent#ACTION_MAIN} with
     * an explicit target activity specified by sourceActivityClass's
     * {@link #PARENT_ACTIVITY} &lt;meta-data&gt; element in the application's
     * manifest.
     * 
     * @param context
    ...
    public static Intent getParentActivityIntent(Context context,
        ...
        if (parentActivity == null) return null;
        return new Intent(Intent.ACTION_MAIN).setClassName(context,
                parentActivity);
    }
    ...
    public static String getParentActivityName(Context context,
        ...
        ActivityInfo info = pm.getActivityInfo(componentName,
