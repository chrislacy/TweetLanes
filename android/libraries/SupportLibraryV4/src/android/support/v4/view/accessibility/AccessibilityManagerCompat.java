...
/**
 * Helper for accessing features in {@link AccessibilityManager} introduced
...
public class AccessibilityManagerCompat {
    ...
    static class AccessibilityManagerStubImpl implements
    ...
    static class AccessibilityManagerIcsImpl extends
            AccessibilityManagerStubImpl {

        @Override
        public Object newAccessiblityStateChangeListener(
                final AccessibilityStateChangeListenerCompat listener) {
            return AccessibilityManagerCompatIcs
                    .newAccessibilityStateChangeListener(new AccessibilityStateChangeListenerBridge() {
        ...
        public boolean addAccessibilityStateChangeListener(
                ...
                AccessibilityStateChangeListenerCompat listener) {
            return AccessibilityManagerCompatIcs
                    .addAccessibilityStateChangeListener(manager,
                            listener.mListener);
        }
        ...
        public boolean removeAccessibilityStateChangeListener(
                ...
                final AccessibilityStateChangeListenerCompat listener) {
            return AccessibilityManagerCompatIcs
                    .removeAccessibilityStateChangeListener(manager,
                            listener.mListener);
        }
        ...
        public List<AccessibilityServiceInfo> getEnabledAccessibilityServiceList(
                AccessibilityManager manager, int feedbackTypeFlags) {
            return AccessibilityManagerCompatIcs
                    .getEnabledAccessibilityServiceList(manager,
                            feedbackTypeFlags);
        }
        ...
        public List<AccessibilityServiceInfo> getInstalledAccessibilityServiceList(
                AccessibilityManager manager) {
            return AccessibilityManagerCompatIcs
                    .getInstalledAccessibilityServiceList(manager);
        }

        @Override
        public boolean isTouchExplorationEnabled(AccessibilityManager manager) {
            return AccessibilityManagerCompatIcs
                    .isTouchExplorationEnabled(manager);
        }
    }
    ...
    /**
     * Registers an
     * {@link AccessibilityManager.AccessibilityStateChangeListener} for changes
     * in the global accessibility state of the system.
     * 
     * @param manager
    ...
    /**
     * Unregisters an
     * {@link AccessibilityManager.AccessibilityStateChangeListener}.
     * 
     * @param manager
     *            The accessibility manager.
     * @param listener
    ...
    /**
     * Returns the {@link AccessibilityServiceInfo}s of the installed
     ...
     * accessibility services for a given feedback type.
     * 
     * @param manager
     *            The accessibility manager.
    ...
    public static List<AccessibilityServiceInfo> getEnabledAccessibilityServiceList(
            AccessibilityManager manager, int feedbackTypeFlags) {
        return IMPL.getEnabledAccessibilityServiceList(manager,
                feedbackTypeFlags);
    }
