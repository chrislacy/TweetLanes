...
/**
 * Helper for accessing features in {@link ViewGroup} introduced after API level
 * 4 in a backwards compatible fashion.
 */
public class ViewGroupCompat {

    interface ViewGroupCompatImpl {
        public boolean onRequestSendAccessibilityEvent(ViewGroup group,
    ...
    static class ViewGroupCompatIcsImpl extends ViewGroupCompatStubImpl {
        ...
        public boolean onRequestSendAccessibilityEvent(ViewGroup group,
                View child, AccessibilityEvent event) {
            return ViewGroupCompatIcs.onRequestSendAccessibilityEvent(group,
                    child, event);
        }
    }
     ...
     * {@link ViewCompat#setAccessibilityDelegate(View, AccessibilityDelegateCompat)}
     * its
     * {@link AccessibilityDelegateCompat#onRequestSendAccessibilityEvent(ViewGroup, View, AccessibilityEvent)}
