 ...
 * implementation, only sufficient for the needs of {@link AsyncTaskLoader}.
 */
abstract class ModernAsyncTask<Params, Progress, Result> {
        ...
        mFuture = new FutureTask<Result>(mWorker) {
            ...
            protected void done() {
                try {
                    ...
                    final Result result = ModernAsyncTask.this.get();
                    // TWEETLANES
     ...
     */
    public final ModernAsyncTask<Params, Progress, Result> execute(
            Params... params) {
